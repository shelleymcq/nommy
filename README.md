...
![logged out homepage](./client/src/assets/img/loggedOut-homepage.png)

_Login:_

![log in](./client/src/assets/img/login.png)

_Signup:_

![sign up](./client/src/assets/img/signup.png)

_Homepage (Logged in):_

![logged in homepage](./client/src/assets/img/loggedIn-homepage.png)
...
![search for restaurant](./client/src/assets/img/search.png)

_Slate:_

![slate view](./client/src/assets/img/slate.png)
